export const nationalitiesFr: string[] = [
  ...
  'Cabo Verde', 'Cambodge', 'Cameroun', 'Canada', 'Chili', 'Chine', 'Chypre', 'Colombie', 'Comores', 'Congo (RDC)', 'Congo (République)', 'Corée du Nord', 'Corée du Sud', 'Costa Rica', 'Côte d’Ivoire',
  'Croatie', 'Cuba',
  ...
  'Saint-Kitts-et-Nevis', 'Sainte-Lucie', 'Saint-Marin', 'Saint-Vincent-et-les-Grenadines', 'Salomon (Îles)', 'Salvador', 'Samoa', 'Sao Tomé-et-Principe', 'Sénégal', 'Serbie', 'Seychelles', 'Sierra Leone', 'Singapour', 'Slovaquie', 'Slovénie', 'Somalie', 'Soudan', 'Soudan du Sud', 'Sri Lanka', 'Suède', 'Suisse', 'Suriname', 'Syrie',
